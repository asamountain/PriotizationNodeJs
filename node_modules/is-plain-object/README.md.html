...
<pre><code class="language-sh">$ npm install --save is-plain-object
</code></pre>
...
<h2>Usage</h2>
<p>with es modules</p>
<pre><code class="language-js">import { isPlainObject } from 'is-plain-object';
</code></pre>
<p>or with commonjs</p>
<pre><code class="language-js">const { isPlainObject } = require('is-plain-object');
</code></pre>
<p><strong>true</strong> when created by the <code>Object</code> constructor, or Object.create(null).</p>
<pre><code class="language-js">isPlainObject(Object.create({}));
//=&gt; true
...
<pre><code class="language-js">isPlainObject(1);
//=&gt; false
isPlainObject(['foo', 'bar']);
//=&gt; false
isPlainObject([]);
...
| --- | --- |<br />
| 19 | <a href="https://github.com/jonschlinkert">jonschlinkert</a> |<br />
| 6  | <a href="https://github.com/TrySound">TrySound</a> |<br />
| 6  | <a href="https://github.com/stevenvachon">stevenvachon</a> |<br />
| 3  | <a href="https://github.com/onokumus">onokumus</a> |<br />
| 1  | <a href="https://github.com/wtgtybhertgeghgtwtg">wtgtybhertgeghgtwtg</a> |</p>
<h3>Author</h3>
