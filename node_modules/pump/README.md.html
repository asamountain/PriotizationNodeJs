<html><head><title>README.md</title></head><body><h1>pump</h1>
...
<p>Note that <code>pump</code> attaches error handlers to the streams to do internal error handling, so if <code>s2</code> emits an
error in the above scenario, it will not trigger a <code>proccess.on('uncaughtException')</code> if you do not listen for it.</p>
...
<p>The maintainers of pump and thousands of other packages are working with Tidelift to deliver commercial support and maintenance for the open source dependencies you use to build your applications. Save time, reduce risk, and improve code health, while paying the maintainers of the exact dependencies you use. <a href="https://tidelift.com/subscription/pkg/npm-pump?utm_source=npm-pump&amp;utm_medium=referral&amp;utm_campaign=enterprise">Learn more.</a></p>
</body></html>