<html><head><title>README.md</title></head><body><h1>color-support</h1>
...
<h2>USAGE</h2>
<pre><code class="language-javascript">var testColorSupport = require('color-support')
...
<pre><code class="language-javascript">var colorSupport = require('color-support')
